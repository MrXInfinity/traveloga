...
const OfferHeader = () => { 
  ...
  return (
  <header className='flex h-48 md:h-64 lg:h-72 w-10/12 bg-cover mt-36 md:mt-40 mb-10 md:mb-12 mx-auto bg-center bg-[url("https://images.pexels.com/photos/8031711/pexels-photo-8031711.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")]'>
