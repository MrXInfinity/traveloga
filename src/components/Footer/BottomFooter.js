            ...
            <section className='flex flex-col md:flex-row-reverse w-full bg-[#2B8E9B] py-8 px-14 lg:px-14 lg:py-8 items-center md:items-start'>
                ...
                <div className="flex flex-col lg:w-1/3 mt-6 md:mt-0 items-center md:items-start">
                    <div className="flex items-center">
                        <FontAwesomeIcon className='text-white text-4xl mr-2' icon={faCompass} />
                        <div className="font-['Spinnaker'] text-white flex-col w-40 md:w-fit">
                    ...
                    <div className="flex flex-col text-center md:text-left mt-6 md:mt-3">
                        {["500 Terry Francois Street", "San Francisco, CA 94158", "info@mysite.com", "Tel: 123-456-7890", "Fax: 123-456-7890", "2023 by TRAVELOGA. Proudly created by Johann Isaiah Mendoza"].map((text, index)=>
